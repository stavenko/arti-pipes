...
impl crate::executor::PromptExecutor for GptOss {
...
impl GptOss {
    async fn execute_internal(
        ...
        let think_value = self.config.reasoning_effort.clone();
        ...
        let output_handle = tokio::spawn(async move {
            ...
            // Use thinking if content is empty
            let final_response = if response_content.is_empty() {
                thinking_content
            } else {
                response_content
            };
